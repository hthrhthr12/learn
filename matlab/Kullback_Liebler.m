...
% Examples:
% Kullback_Liebler('Normal','mu',75,'sigma',10);
%
clc
...
KL_100_1000=KL_between_samples(pdfs_return{1:2});
KL_100_10000=KL_between_samples(pdfs_return{[1,3]});
KL_1000_1000=KL_between_samples(pdfs_return{2},pdfs_return{2});
close all
end
